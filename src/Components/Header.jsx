      ...
      <div className="top-navigation">
        <div className="container">
          <div className="header-content flex">
            ...
            <div className="content__contact flex">
              <Link className="content__contact--tel flex" to="#">
                <svg width="17" height="17" viewBox="0 0 19 19" fill="none">
                  <path
                    d="M6.12334 1H3.42857C2.08731 1 1 2.08731 1 3.42857V5.85714C1 12.5635 6.43654 18 13.1429 18H15.5714C16.9127 18 18 16.9127 18 15.5714V13.8933C18 13.4334 17.7401 13.0129 17.3288 12.8072L14.3951 11.3404C13.7342 11.01 12.9338 11.3415 12.7001 12.0425L12.3385 13.1272C12.1043 13.8299 11.3836 14.2481 10.6573 14.1029C7.75057 13.5215 5.47846 11.2494 4.89711 8.34268C4.75186 7.61643 5.17013 6.89567 5.87276 6.66146L7.21895 6.21273C7.8209 6.01208 8.16688 5.38181 8.01299 4.76625L7.30137 1.91978C7.16623 1.37922 6.68054 1 6.12334 1Z"
                    stroke="white"
                  />
                </svg>
                8 (964) 89 99 119
